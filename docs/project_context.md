...
| **Leave Management** | Comprehensive Leave Application, Approval, and Balance Tracking; Dedicated pages for Pending, Approved, On-Leave, and Returning Staff; 'Is Paid' field for Leave Types. | **Complete** | Full CRUD for leave types, application workflow, and employee leave balance management. |

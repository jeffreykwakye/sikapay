...
| **Employee Management** | CRUD for Employees, Departments, and Positions; Active/Inactive Staff Views; Immediate Basic Salary Update with History Logging | **Complete** | Full employee lifecycle management, including personal, statutory, bank, and immediate basic salary updates with history logging, with categorized staff views. |
...
| **Leave Management** | Comprehensive Leave Application, Approval, and Balance Tracking; **Simplified UI with Details Modal** | In Progress | Full workflow for leave application, approval, and balance tracking. Includes a complete notification loop (in-app & email) for submissions, approvals, and rejections. UI is being refactored for improved clarity and user experience, introducing simplified tables and detailed view modals for applications. |
...
| **Departmental Reports** | Dedicated dashboard for generating department-specific reports (Payslips, PAYE, SSNIT, Bank Advice). | **Complete** | Dedicated dashboard for generating department-specific reports (Payslips, PAYE, SSNIT, Bank Advice) with accurate, filtered data and dynamic headers. |

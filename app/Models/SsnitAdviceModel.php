...
class SsnitAdviceModel extends Model
{
    public function __construct()
    {
        parent::__construct('ssnit_advice');
    }
    ...
    public function getAdviceByPeriod(int $payrollPeriodId, int $tenantId): array
    {
        ...
        try {
            ...
            Log::error("Failed to retrieve SSNIT advice for period {$payrollPeriodId} (tenant {$tenantId}). Error: " . $e->getMessage());
            return [];
        }
    }

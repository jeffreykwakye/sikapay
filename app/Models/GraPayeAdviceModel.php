...
class GraPayeAdviceModel extends Model
{
    public function __construct()
    {
        parent::__construct('gra_paye_advice');
    }
    ...
    public function getAdviceByPeriod(int $payrollPeriodId, int $tenantId): array
    {
        ...
        try {
            ...
            Log::error("Failed to retrieve PAYE advice for period {$payrollPeriodId} (tenant {$tenantId}). Error: " . $e->getMessage());
            return [];
        }
    }

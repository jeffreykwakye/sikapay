...
$v = fn($key, $default = '') => $h($input[$key] ?? ($rate[$key] ?? $default));
?>
...
<div class="page-header">
    ...
    <ul class="breadcrumbs mb-3">
        ...
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="#">Edit Withholding Tax Rate</a></li>
    </ul>
</div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Withholding Tax Rate (ID: <?= $h($rate['id']) ?>)</h4>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
                ...
                <form action="/super/statutory-rates/wht/<?= $h($rate['id']) ?>" method="POST">
                    <?= $CsrfToken::field() ?>
                    ...
                    <div class="card-action text-end">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i> Update WHT Rate</button>
